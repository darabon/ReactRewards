        ...
        <div className='Weekly-Left'>
            <div className='Person'>
                ...
                <div className='Achivments'>
                    {
                        review.achivments && review.achivments.map((icon, index) => (
                            icon ? <img key={index} src={icon} alt="achievement" className="icon"/> : null
                        ))
                    }
                </div>
            </div>
        ...
        <div className='Weekly-Right'>
            ...
            <div className='Person-Card'>
                <div className='Person-Avatar'>
                    ...
                    {referal.avatar ? <img src={referal.avatar} alt=""/> : null}
                ...
                <div className='Big-Achivment'>
                    <div>
                        {referal.ref_icon ? <img src={referal.ref_icon} alt=""/> : null}
                        <h3 className='Quantity'>{referal.referals}</h3>
                        <p className='Name-Quantity'>Referasl</p>
                    </div>

                    <div>
                        {referal.rew_icon ? <img src={referal.rew_icon} alt="" className="icon"/> : null}
